    ...
    <div className="">
      ...
      <div className="relative overflow-x-hidden overflow-y-hidden md:hidden bg-gradient-to-b from-white to-a-color pb-4">
        ...
        <div className=" relative w-[60%] m-auto h-20 border-[1px] text-ironside-grey text-md border-azul border-b-0 mb-4 mt-8">
          <span className=" absolute w-[4rem] left-[-4rem]  top-[1rem] ">商务协议 开发票、 提供发票</span>
          <span className="absolute w-[4rem] left-[0.5rem]  top-[1rem] ">代发费用 + <br/>服务费</span>
          <span className="absolute w-[2rem] left-[40%]  top-[1rem] translate-x-[-45%]">业务合作协议</span>
          <span className="absolute w-[2rem] left-[60%]  top-[1rem] translate-x-[-45%]">完税证明</span>
          <span className="absolute w-[0.5rem]  top-[1rem] right-[1rem]">代报税</span>
          <span className="absolute w-[2rem]  top-[1rem] right-[-2.5rem]">完税证明</span>
        </div>
        {/* contents */}
