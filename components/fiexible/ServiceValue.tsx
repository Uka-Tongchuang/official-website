...
function ServiceValue() {
  ...
  <div className="w-[80%] relative h-auto bg-a-color rounded-2xl mt-10 m-auto py-10">
    ...
    <div className="aa absolute bottom-0 right-0 w-36 h-36 xl:w-56 xl:h-56 z-10"> {/* 图片的z-index调低 */}
    </div>
  </div>
</div>
