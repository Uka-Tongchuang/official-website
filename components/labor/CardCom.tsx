...
function CardCom() {
  ...
  return (
    <div className="w-full h-auto box p-8">
      ...
      <div className="w-[90%] m-auto grid grid-cols-2  gap-6 md:w-[80%] md:grid-cols-4 md:h-60 xl:w-[80%] xl:m-auto xl:h-auto item_boxs xl:p-8">
        {content.moduleData.card.map((item, index) => {
          return (
            <div
              key={index}
              className="flex h-52 xl:mt-10 xl:h-[24rem] flex-col items-center xl:items-start"
            >
              <Image
              ...
              <p className="text-sm text-gray-500 xl:text-lg xl:mt-2 xl:ml-4 text-center">
                {item.en}
              </p>
              <Image
