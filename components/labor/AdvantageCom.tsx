  ...
  return (
    <div className="w-[90%] h-auto m-auto md:w-[80%] bg-a-color md:flex md:items-center md:mt-20 md:mb-20 md:rounded-xl">
      ...
      <div className="p-4 md:w-[58%] md:mb-8">
        <h4 className="font-bold text-center md:py-6 md:text-left text-lg md:text-lg xl:text-3xl">
          {title}
        </h4>
        {arr.map((item, index) => (
          <div
          ...
          >
            <p className="text-md h-8 font-bold xl:text-lg xl:h-10">{item.title}</p>
