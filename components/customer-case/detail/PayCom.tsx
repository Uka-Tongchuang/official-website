...
function PayCom({ id }: { id: number }) {
  return (
    <div>
      ...
      {id == 2 ? (
        <div className=" w-[80%] shadow-circle-bg m-auto shadow-xl p-4 my-20 rounded-lg relative before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-1 before:bg-white before:shadow-md before:shadow-circle-bg">
          <h3 className="text-center font-bold text-3xl py-8">交付模式</h3>
