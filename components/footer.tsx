...
import Map from '@/public/footer-icon/location.png';
//footer-bg
        ...
        <div className=''>
            ...
            <div className='box w-[95%] m-auto  xl:hidden'>
                ...
                <div className='w-[95%] m-auto'>
                    ...
                    <div
                        ...
                        <div className='flex-1 flex-col juctify-between p-5'>
                            ...
                            <div className='flex flex-row justify-between items-center'>
                                <span className='text-md text-gray-400 text-pretty basis-2/12'>
                                    地址
                                </span>
                                <span className='text-md basis-9/12 text-right'>
                                  四川省成都市锦江区东大路577号ICC办公楼10楼
                                </span>
                            </div>
                            <div className='flex justify-between items-center'>
                                <span className='text-md text-gray-400'>
                    ...
                    {/* 底部信息 */}
                    <div className='w-full h- text-xs text-gray-400 py-6 text-center'>
                    <p>2023今创人力有限公司</p>
                    <p>The company was established in 2023</p>
                    <p>Pages Created in 2024 by <a href='https://jinchuanghr.com' target="_blank" id='officialWebsite' className='font-bold underline hover:no-underline'>Jinchuang HR</a>. All right reserved.</p>
                    </div>
                </div>
            </div>
            {/* pc端 */}
            <div className='hidden xl:flex flex-col'>
                ...
                <div className='relative'>
                    ...
                    <div className='w-[90%] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] h-[100px] flex flex-col justify-between items-center'>
                        <p className='text-3xl'>
                            ...
                            家企业提供服务，服务人数超过
                            <span className='text-azul'>50W+</span>
                        </p>
                ...
                <div className='h-[600px] w-full bg-footer-black'>
                        ...
                        <div className='flex w-[33%] pl-14'>
                            <div className='w-[50%]'>
                                ...
                                <div className='flex flex-col justify-around h-60 text-md text-nav-font-color'>
                                    <a href='/products/personnel-management'>
                                        人事派遣
                                    </a>
                                    <a href='/products/labor-dispatch'>
                                        劳务派遣
                                    </a>
                                    <a href='/products/position-outsource'>
                                        岗位外包
                                    </a>
                                    <a href='/products/business-outsource'>
                                        业务外包
                                    </a>
                                    <a href='/products/recruitment'>
                                        招聘流程外包
                                    </a>
                                    <a href='/products/flexible-outsource'>
                                        灵活用工解决方案
                                    </a>
                                </div>
                            </div>
                    ...
                    <div className='w-[70%] text-white h-[100px] m-auto border-t border-y-zinc-600 flex flex-col justify-center items-center'>
                        ...
                        <p>The company was established in 2023 | Pages Created in 2024 by <a href='https://jinchuanghr.com' target="_blank" id='officialWebsite' className='font-bold underline hover:no-underline'>Jinchuang HR</a>. All right reserved.</p>
                    </div>
                </div>
            </div>
        </div>
